...
// of the plugin-facing tests see it. This guard pins the two facts the
// AGENTS.md pointer depends on: the skill exists at the harness-neutral
// `.agents/skills` path (which OMP discovers directly, not through any symlink
// shim) and AGENTS.md still routes skill work to it.
