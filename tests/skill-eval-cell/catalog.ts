...
export type Grade = {
  ...
  /** Text that must not appear inside the run's RESULT-START/RESULT-END block: a source phrase that survived the edit. Absent block fails. */
...
- U2. test/greet.test.js: add both cases using node:test.`,
  ...
  {
    id: "ce-plan/durable-final-check-dispatches-planner",
    skill: "ce-plan",
    cohort: "resized",
    key_behavior: "judgment",
    read_only: true,
