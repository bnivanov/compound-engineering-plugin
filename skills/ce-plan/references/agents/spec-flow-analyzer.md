...
1. Use the native content-search tool (e.g. the grep tool) to find code related to the feature area -- models, controllers, services, routes, existing tests
2. Use the native file-search tool (e.g. the glob tool) to find related features that may share patterns or integrate with this one
