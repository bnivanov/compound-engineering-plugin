...
**User-runnable invocation rendering.** Only the user-run handoff below uses printed invocation syntax. Render as `/skill:ce-polish`. Render only the invocation as inline code and output one form only.
