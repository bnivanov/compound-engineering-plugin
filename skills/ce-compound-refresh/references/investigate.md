...
>
> Also check OMP memory via recall (memory://) for notes related to the learning's problem domain. Report any memory-sourced drift signals separately from codebase-sourced evidence, tagged with "(OMP memory)" in the evidence section. If no relevant notes are found, skip this check.
>
