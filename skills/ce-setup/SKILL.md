---
name: ce-setup
description: "Check Compound Engineering health and repo-local config, or scaffold a Compound Pack with `pack:<id>`. Use when installing, after an upgrade, when a skill reports a missing tool, or when asked to set the plugin up."
