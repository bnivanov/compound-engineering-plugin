#!/usr/bin/env python3
"""Extract error signals from a Pi or oh-my-pi (omp) JSONL session file.
...
# Unrecognized shapes fall through to the pi handler, which ignores
# entries without a type:'message' envelope.
